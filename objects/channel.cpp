...
//	if(frame_lock && bit_lock && !bit_lock_pend && !frame_lock_pend && !z_count_pend &&
//	(valid_frame[0] || valid_frame[1] || valid_frame[2] || valid_frame[3] || valid_frame[4]))
//		_feedback->navigate = true;
//	else

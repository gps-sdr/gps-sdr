...
#define TWO_N5				(0.031250000000e+000)	//!< 2^-5
#define TWO_N11				(4.882812500000e-004)	//!< 2^-11
#define TWO_N19				(1.907348632813e-006)	//!< 2^-19
#define TWO_N20				(9.536743164063e-007)	//!< 2^-20
#define TWO_N21				(4.768371582031e-007)	//!< 2^-21
#define TWO_N24				(5.960464477539e-008)	//!< 2^-24
#define TWO_N25				(2.980232238769e-008)	//!< 2^-25
#define TWO_N27				(7.450580596924e-009)	//!< 2^-27
#define TWO_N29				(1.862645149231e-009)	//!< 2^-29
#define TWO_N30				(9.313225746155e-010)	//!< 2^-30
#define TWO_N31				(4.656612873077e-010)	//!< 2^-31
#define TWO_N32				(2.328306436539e-010)	//!< 2^-32
#define TWO_N33				(1.164153218269e-010)	//!< 2^-33
#define TWO_N38				(3.637978807092e-012)	//!< 2^-38
#define TWO_N43				(1.136868377216e-013)	//!< 2^-43
#define TWO_N50				(8.881784197001e-016)	//!< 2^-50
#define TWO_N55				(2.775557561563e-017)	//!< 2^-55

#define PI_TWO_N19			(5.992112452678e-006)	//!< Pi*2^-19
#define PI_TWO_N43			(3.571577341961e-013)	//!< Pi*2^-43 
#define PI_TWO_N31			(1.462918079267e-009)	//!< Pi*2^-31
#define PI_TWO_N38			(1.142904749427e-011)	//!< Pi*2^-38
#define PI_TWO_N23			(3.745070282924e-007)	//!< Pi*2^-23
